        ...
        <div class="layui-side-scroll" >
            ...
            <ul class="layui-nav layui-nav-tree "lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="javascript:;">老师权限</a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" url="/teacherquerycoursestudent?method=query1&tid=${teacher.tid}">查看选课学生</a>
                        </dd>
                        <dd>
                            <a href="javascript:;" url="/teacherupdatescore?method=querycount&tid=${teacher.tid}">查看统计</a>
                        </dd>
                        <dd>
                            <a href="javascript:;" url="/teacherupdatescore?method=updatescore&tid=${teacher.tid}">成绩录入</a>
                        </dd>
                    </dl>
                </li>
            </ul>
